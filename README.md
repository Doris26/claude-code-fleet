...
| **Agent frameworks** — [LangGraph](https://github.com/langchain-ai/langgraph), [CrewAI](https://github.com/crewAIInc/crewAI), [AutoGen/AG2](https://github.com/ag2ai/ag2), [OpenHands](https://github.com/All-Hands-AI/OpenHands) | Libraries/runtimes to *define and execute* agent graphs from scratch | A different layer entirely — claude-code-fleet doesn't define agent graphs, it supervises sessions you already run. |
